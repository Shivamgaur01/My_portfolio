const experiences = [
  {
    ...
    description: "Working at ARM WorldWide as a Software Engineer involves developing end-to-end web solutions by handling both frontend and backend responsibilities. On the frontend, I build responsive, user-friendly interfaces using modern JavaScript frameworks. On the backend, I develop scalable server-side applications, create CMS dashboards using Node.js, and integrate APIs to ensure seamless data flow.In addition to custom development, I also work extensively with CMS platforms like WordPress and Sitecore, building and managing dynamic websites tailored to business needs. This role provides a comprehensive full-stack development experience, covering everything from UI development to backend logic and content management systems.",
    technologies: ["React", "NextJs", "JavaScript", "NodeJs", "MongoDB", "ExpressJs", "Wordpress", "Sitecore", "Redis", "PHP", "Docker"],
    current: true
